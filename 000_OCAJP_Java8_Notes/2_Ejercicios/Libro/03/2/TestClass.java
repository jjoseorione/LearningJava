...
public class TestClass{
	...
	public static void main(String[] args){
		...
		System.out.println("height: " + bs.height);			//Imprime 0 debido a que es numérica
		System.out.println("height: " + bs.weight);			//Imprime 0 debido a que es numérica
		...
		System.out.println("doble: " + bs.doble);			//Imprime 0 debido a que es numérica
		System.out.println();
