...
public class Course{
	...
	public static void enroll(Student s1){
		...
		// s1.varDefault = "Default cambiado en enroll";		//error, is not public
		// s1.varProtected = "Protected cambiado en enroll";	//error, has protected access
		// s3.varPrivate = "Private cambiado en enroll";		//error, cannot find symbol
